...
for year in 2015; do
    ...
    files0=( /jet/home/xjliu/Amazon_exp/Amazon561x721/3Dfields_d01_$year-11-01_15* )
    files1=( /jet/home/xjliu/Amazon_exp/Amazon561x721_ILdeforested/3Dfields_d01_$year-11-01_15* )
...
#      echo ${files0[@]}
    ...
    ncrcat -O -v $var ${files1[@]} $fout1.nc2
	ncea -O -v $var ${files0[@]:5:25} $fout0.multidaymean.nc2
	ncea -O -v $var ${files1[@]:5:25} $fout1.multidaymean.nc2
